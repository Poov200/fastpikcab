            ...
            <div class="flex flex-col lg:flex-row">
                ...
                <div class="lg:w-2/3 lg:pr-8 mb-10 lg:mb-0">
                    <div class="bg-white rounded-lg shadow-md p-8">
                        ...
                        <form id="contactForm" class="space-y-6" name="contactForm" ng-submit="submitForm()"
                            novalidate>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="name" class="block text-gray-700 font-medium mb-2">Your
                                        Name</label>
                                    <input type="text" ng-model="formData.name" id="name" name="name"
                                        class="contact-input w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
                                        required>
                                ...
                                <div>
                                    <label for="email" class="block text-gray-700 font-medium mb-2">Email
                                        Address</label>
                                    <input type="email" ng-model="formData.email" id="email" name="email"
                                        class="contact-input w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
                                        required>
                            ...
                            <div>
                                <label for="phone" class="block text-gray-700 font-medium mb-2">Phone
                                    Number</label>
                                <input type="tel" ng-model="formData.phone" id="phone" name="phone"
                                    class="contact-input w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400">
                            </div>
                            <div>
                                <label for="subject" class="block text-gray-700 font-medium mb-2">Subject</label>
                                <select id="subject" ng-model="formData.subject" name="subject"
                                    class="contact-input w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400">
                            ...
                            <div>
                                <label for="message" class="block text-gray-700 font-medium mb-2">Your
                                    Message</label>
                                <textarea id="message" ng-model="formData.message" name="message" rows="5"
                                    class="contact-input w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400"
                                    required></textarea>
                            ...
                            <div>
                                <button type="submit" ng-disabled="contactForm.$invalid || isSubmitting"
                    ...
                    <div class="bg-gray-900 text-white rounded-lg shadow-md p-8 h-full">
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-300">Throwpathi Amman Koil St,<br> Kalinjikuppam, Tamil Nadu
                                        607104</p>
                                </div>
                            </div>
                        ...
                        <div class="mt-8">
                            ...
                            <div class="flex space-x-4">
                                <a href="https://www.facebook.com/profile.php?id=61576659986681"
                                    class="bg-gray-800 hover:bg-yellow-400 hover:text-gray-900 h-10 w-10 rounded-full flex items-center justify-center transition duration-300">

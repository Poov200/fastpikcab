...
<head>
    ...
    <title>Fastpik Cab - Bangalore to Thiruvarur Taxi Service | Book Online</title>

    <meta name="description"
        content="Book a reliable Bangalore to Thiruvarur taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, and outstation travel. We offer comfortable cabs for your journey.">
        ...
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
                <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-4">
                    Reliable <span class="text-blue-600">Taxi Service</span> from Bangalore to Thiruvarur
                </h1>
            ...
            <div class="bg-white p-6 md:p-8 rounded-xl shadow-lg">
                ...
                <form action="/book-now" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="drop" name="drop" placeholder="Thiruvarur" required
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <span>Salem</span>
                            <span class="text-sm text-gray-500">A major city with good dining and refreshment options.</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <span>Thanjavur</span>
            ...
            <table class="w-full table-auto">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center">₹11,984</td>

...
<head>
    ...
    <meta property="og:title" content="Fastpik Cab - Pudukkottai to Erode Taxi Service">
    ...
    <meta name="twitter:description"
        content="Book a reliable Pudukkottai to Erode taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, or outstation travel.">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Pudukkottai to Erode Taxi Service | Fastpik Cab",
...
<section class="mb-12 px-4 md:px-12">
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Pudukkottai to Erode Taxi Service – Fastpikcab
    </h1>

...
<head>
    ...
    <title>Fastpik Cab - Salem to Sivakasi Taxi Service </title>
    ...
    <meta name="twitter:description"
        content="Book a reliable Salem to Sivakasi taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, or outstation travel.">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Salem to Sivakasi Taxi Service | Fastpik Cab",
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Salem to Sivakasi Taxi Service – Fastpikcab
    </h1>

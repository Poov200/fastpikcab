...
<head>
    ...
    <title>Fastpik Cab - Thoothukudi to Vellore Taxi Service</title>
    ...
    <meta name="twitter:description"
        content="Book a reliable Thoothukudi to Vellore taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, and outstation travel.">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Thoothukudi to Vellore Taxi Service | Fastpik Cab",
...
<section class="mb-12 px-4 md:px-12">
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Thoothukudi to Vellore Taxi Service – Fastpikcab
    </h1>

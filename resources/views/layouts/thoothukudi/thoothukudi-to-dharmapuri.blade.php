...
<head>
    ...
    <title>Fastpik Cab - Thoothukudi to Dharmapuri Taxi Service </title>
    ...
    <meta name="twitter:description"
        content="Book a reliable Thoothukudi to Dharmapuri taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, and outstation travel.">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Thoothukudi to Dharmapuri Taxi Service | Fastpik Cab",
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Thoothukudi to Dharmapuri Taxi Service – Fastpikcab
    </h1>

    ...
    <script type="application/ld+json">
        {
            ...
            "makesOffer": {
                ...
                "itemOffered": {
                    "@type": "Service",
                    "name": "Thiruvannamalai to Cuddalore Taxi Service",
                    "description": "Reliable taxi service connecting Thiruvannamalai to Cuddalore with options for one-way, round-trip, and outstation travel.",
                    "serviceType": "TaxiService",
                    "areaServed": ["Thiruvannamalai", "Cuddalore"],
                    "provider": {
                        "@type": "Organization",
                        "name": "Fastpik Cab"
                    }
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Thiruvannamalai to Cuddalore Taxi Service | Fastpik Cab",
            "description": "Book affordable and reliable taxis from Thiruvannamalai to Cuddalore. Choose from hatchback, sedan, SUV, and premium vehicles for a comfortable travel.",
            "breadcrumb": {
                "@type": "BreadcrumbList",
                "itemListElement": [{
                    "@type": "ListItem",
                    ...
                    "item": "https://www.fastpikcab.com/thiruvannamalai-to-cuddalore-drop-taxi"
                }]
            },
            "mainEntityOfPage": {
                "@type": "Product",

...
<head>
    ...
    <title>Fastpik Cab - Krishnagiri to Ariyalur Taxi Service</title>
    ...
    <meta name="twitter:description"
        content="Book a reliable Krishnagiri to Ariyalur taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, or outstation travel.">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Krishnagiri to Ariyalur Taxi Service | Fastpik Cab",
...
<section class="mb-12 px-4 md:px-12">
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Krishnagiri to Ariyalur Taxi Service – Fastpikcab
    </h1>

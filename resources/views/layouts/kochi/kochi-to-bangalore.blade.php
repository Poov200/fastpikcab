...
<body>
    ...
    <h2 class="text-3xl font-bold text-center mb-8 text-gray-800">
        Book Affordable Kochi to Bangalore Cabs Online
    </h2>
    <div class="bg-white rounded-xl shadow-md p-8 text-gray-700 leading-relaxed">
        <p class="mb-4">
            Looking for a comfortable journey from <strong>Kochi to Bangalore</strong>? Fastpikcab offers
        ...
        <p class="mb-4">
            The distance from Kochi to Bangalore is around <strong>550 km</strong>,
        ...
        <p class="mb-4">
            Booking your <strong>Kochi to Bangalore taxi</strong> with Fastpikcab is quick and simple.
        ...
        <p>
            Choose Fastpikcab for your <strong>Kochi to Bangalore taxi service</strong> and enjoy

...
<head>
    ...
    <meta property="og:title" content="Fastpik Cab - Kochi to Karur Taxi Service">
    ...
    <meta name="twitter:description" content="Book a reliable Kochi to Karur taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, or outstation travel.">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Kochi to Karur Taxi Service | Fastpik Cab",
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Kochi to Karur Taxi Service – Fastpikcab
    </h1>

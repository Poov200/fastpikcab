...
<head>
    ...
    <meta property="og:title" content="Fastpik Cab - Kochi to Pudukkottai Taxi Service">
    ...
    <meta name="twitter:description" content="Book a reliable Kochi to Pudukkottai taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, or outstation travel.">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Kochi to Pudukkottai Taxi Service | Fastpik Cab",
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Kochi to Pudukkottai Taxi Service – Fastpikcab
    </h1>

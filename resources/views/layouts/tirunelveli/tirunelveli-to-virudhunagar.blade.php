...
<head>
    ...
    <title>Fastpik Cab - Tirunelveli to Virudhunagar Taxi Service </title>
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Tirunelveli to Virudhunagar Taxi Service | Fastpik Cab",
...
<section class="mb-12 px-4 md:px-12">
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Tirunelveli to Virudhunagar Taxi Service – Fastpikcab
    </h1>

...
<head>
    ...
    <title>Fastpik Cab - Tirunelveli to Dindigul Taxi Service</title>
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Tirunelveli to Dindigul Taxi Service | Fastpik Cab",
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Tirunelveli to Dindigul Taxi Service – Fastpikcab
    </h1>

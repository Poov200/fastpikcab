...
<head>
    ...
    <meta name="description" content="Book a reliable Thiruvarur to Thiruvarur taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, and outstation travel. We offer comfortable cabs for your journey.">
    ...
    <script type="application/ld+json">
        {
            ...
            "makesOffer": {
                ...
                "itemOffered": {
                    "@type": "Service",
                    "name": "Thiruvarur Local Taxi Service",
                    "description": "Reliable and convenient local taxi service within Thiruvarur.",
    ...
    <script type="application/ld+json">
        {
            ...
            "mainEntityOfPage": {
                ...
                "offers": {
                    ...
                    "lowPrice": "500",
                    "highPrice": "2000",
                    "offerCount": "Multiple price points based on duration and vehicle type"
                }
            }
        }
    </script>
    ...
    <section class="mb-12 px-4 md:px-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md text-center">
                ...
                <p class="text-gray-600">We promise punctual service for your local commutes and errands.</p>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-md text-center">
                <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p class="text-gray-600">No hidden charges for local trips within Thiruvarur. Affordable rates for hourly and daily packages.</p>
            </div>
        </div>
    </section>

    <section class="mb-12 px-4 md:px-12">
        <h2 class="text-3xl font-bold text-center mb-10 text-gray-800">Thiruvarur Local Taxi Fare Structure</h2>
        <div class="bg-white rounded-xl shadow-md overflow-hidden overflow-x-auto">
            <table class="w-full table-auto">
                <thead class="bg-blue-600 text-white">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-center">Local Travel Fare (approx.)</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center">₹700 - ₹1200 (for 4 hours/40km)</td>
                        <td class="px-6 py-4">
                            <ul class="list-disc list-inside text-sm text-gray-600">
                                <li>Comfortable for families and small groups</li>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center">₹1000 - ₹2000 (for 4 hours/40km)</td>
                        <td class="px-6 py-4">
                            <ul class="list-disc list-inside text-sm text-gray-600">
                                <li>Spacious for larger groups or extra luggage</li>
                                <li>Air-conditioned</li>
            ...
            <div class="p-4 bg-gray-50 text-center">
                <p class="text-sm text-gray-600">* Fares are approximate and subject to change based on specific package, duration, and distance. Please contact us for exact quotes.</p>
            </div>
        </div>
    </section>

    <section class="mb-12 px-4 md:px-12">
        <h2 class="text-3xl font-bold text-center mb-10 text-gray-800">Popular Local Destinations in Thiruvarur</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white p-6 rounded-xl shadow-md text-center">
                <i class="fas fa-mosque text-3xl text-blue-600 mb-4"></i>
                <h3 class="text-xl font-semibold mb-2">Thiruvarur Temple</h3>
                <p class="text-gray-600">One of the most significant Shiva temples in Tamil Nadu.</p>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-md text-center">
                <i class="fas fa-landmark text-3xl text-blue-600 mb-4"></i>
                <h3 class="text-xl font-semibold mb-2">Thiruvarur Palace</h3>
                <p class="text-gray-600">Historical landmark showcasing the region's rich past.</p>
            </div>
            <div class="bg-white p-6 rounded-xl shadow-md text-center">
                <i class="fas fa-shopping-bag text-3xl text-blue-600 mb-4"></i>
                <h3 class="text-xl font-semibold mb-2">Local Markets</h3>
                <p class="text-gray-600">Explore local crafts and daily life in the vibrant markets.</p>
            </div>
        </div>
    </section>

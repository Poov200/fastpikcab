...
<head>
    ...
    <meta name="keywords"
        content=" Fastcab, Fast cab, fast taxi, speed cab, fastpik, local taxi, Low cost , Cab, Taxi near , Cab near, Immediate taxi, Good taxi ,Drop taxi , oneway taxi, Karur to Ariyalur taxi, Karur to Ariyalur one way taxi, Karur to Ariyalur outstation cabs, Karur to Ariyalur taxi fare, Karur to Ariyalur cab fare, Karur to Ariyalur round trip taxi, Karur to Ariyalur car rental, Karur to Ariyalur cab booking">
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Karur to Ariyalur Taxi Service – Fastpikcab
    </h1>

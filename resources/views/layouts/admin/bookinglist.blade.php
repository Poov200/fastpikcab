...
<body ng-controller="BookingController">
    ...
    <script>
        ...
        app.controller('BookingController', function($scope, $http) {
            ...
            $http.get('/api/drivers/active').then(function(response) {
    ...
    $http.patch('/api/bookings/' + booking.id + '/assign-driver', data).then(function(response) {
        ...
        console.error(error);
            ...
            $scope.updateTripStatus = function(booking) {
                ...
                $http.patch('/api/bookings/' + booking.id + '/trip-status', {

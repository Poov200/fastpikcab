        ...
        angular.module('CommissionApp', [])
            .controller('CommissionController', function($scope, $http) {
                ...
                function fetchBookings() {
                    $scope.loading = true;
                    $http.get('/api/completed-bookings').then(function(response) {
        ...
        (function() {
            function c() {
                ...
                if (b) {
                    ...
                    d.innerHTML = "window.__CF$cv$params={r:'9421a074b2367f2e',t:'MTc0NzYzNzA3OC4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";

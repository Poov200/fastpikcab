...
<head>
    ...
    <title>Fastpik Cab - Thanjavur to Kanchipuram Taxi Service</title>
    ...
    <meta name="twitter:description"
        content="Book a reliable Thanjavur to Kanchipuram taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, or outstation travel.">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Thanjavur to Kanchipuram Taxi Service | Fastpik Cab",
...
<section class="mb-12 px-4 md:px-12">
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Thanjavur to Kanchipuram Taxi Service – Fastpikcab
    </h1>

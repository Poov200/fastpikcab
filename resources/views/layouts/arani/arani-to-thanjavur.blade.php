...
<head>
    ...
    <meta name="keywords"
        content=" Fastcab, Fast cab, fast taxi, speed cab, fastpik, local taxi, Low cost , Cab, Taxi near , Cab near, Immediate taxi, Good taxi ,Drop taxi , oneway taxi, Arani to Thanjavur taxi, Arani to Thanjavur one way taxi, Arani to Thanjavur outstation cabs, Arani to Thanjavur taxi fare, Arani to Thanjavur cab fare, Arani to Thanjavur round trip taxi, Arani to Thanjavur car rental, Arani to Thanjavur cab booking">

    <meta property="og:title" content="Fastpik Cab - Arani to Thanjavur Taxi Service">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Arani to Thanjavur Taxi Service | Fastpik Cab",
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Arani to Thanjavur Taxi Service – Fastpikcab
    </h1>

...
<head>
    ...
    <title>Fastpik Cab - Tirupati to Dindigul Taxi Service </title>
    ...
    <meta name="twitter:description"
        content="Book a reliable Tirupati to Dindigul taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, and outstation travel.">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Tirupati to Dindigul Taxi Service | Fastpik Cab",
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Tirupati to Dindigul Taxi Service – Fastpikcab
    </h1>

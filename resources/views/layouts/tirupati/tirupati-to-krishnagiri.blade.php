...
<head>
    ...
    <meta property="og:title" content="Fastpik Cab - Tirupati to Krishnagiri Taxi Service">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Tirupati to Krishnagiri Taxi Service | Fastpik Cab",
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Tirupati to Krishnagiri Taxi Service – Fastpikcab
    </h1>

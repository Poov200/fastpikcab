  ...
  <script type="application/ld+json">
    {
      ...
      "makesOffer": {
        ...
        "itemOffered": {
          ...
          "description": "Reliable taxi service connecting Cuddalore to Salem with one-way and round-trip options.",
...
<body>
  ...
  <!-- Route Details -->
  <section class="mb-12 px-4 md:px-12">
    <h2 class="text-3xl font-bold text-center mb-10">Cuddalore to Salem Route Details</h2>
    <div class="bg-white rounded-xl shadow-md p-8">
      <ul class="space-y-4 text-gray-700">
        <li><strong>Distance:</strong> ~240 km</li>
        <li><strong>Travel Time:</strong> ~5–6 hours</li>
        <li><strong>Route:</strong> Via Villupuram → Ulundurpet → Attur → Salem (NH79)</li>
        <li><strong>Note:</strong> Smooth highway roads, convenient for business, family, and tourist travel.</li>
      </ul>
    </div>
  </section>
  ...
  <!-- Fare Structure -->
  <section class="mb-12 px-4 md:px-12">
    <h2 class="text-3xl font-bold text-center mb-10">Cuddalore to Salem Cab Fares</h2>

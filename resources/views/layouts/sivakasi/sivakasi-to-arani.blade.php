...
<head>
    ...
    <title>Fastpik Cab - Sivakasi to Arani Taxi Service</title>
    ...
    <meta name="twitter:description"
        content="Book a reliable Sivakasi to Arani taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, or outstation travel.">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Sivakasi to Arani Taxi Service | Fastpik Cab",
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Sivakasi to Arani Taxi Service – Fastpikcab
    </h1>

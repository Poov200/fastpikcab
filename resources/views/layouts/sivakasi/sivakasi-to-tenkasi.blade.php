...
<head>
    ...
    <title>Fastpik Cab - Sivakasi to Tenkasi Taxi Service</title>
    ...
    <meta name="twitter:description"
        content="Book a reliable Sivakasi to Tenkasi taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, or outstation travel.">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Sivakasi to Tenkasi Taxi Service | Fastpik Cab",
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Sivakasi to Tenkasi Taxi Service – Fastpikcab
    </h1>

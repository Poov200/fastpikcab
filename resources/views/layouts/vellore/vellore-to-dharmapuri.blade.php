...
<head>
    ...
    <meta name="keywords"
        content=" Fastcab, Fast cab, fast taxi, speed cab, fastpik, local taxi, Low cost , Cab, Taxi near , Cab near, Immediate taxi, Good taxi ,Drop taxi , oneway taxi, Vellore to Dharmapuri taxi, Vellore to Dharmapuri one way taxi, Vellore to Dharmapuri outstation cabs, Vellore to Dharmapuri taxi fare, Vellore to Dharmapuri cab fare, Vellore to Dharmapuri round trip taxi, Vellore to Dharmapuri car rental, Vellore to Dharmapuri cab booking">

    <meta property="og:title" content="Fastpik Cab - Vellore to Dharmapuri Taxi Service">
    ...
    <script type="application/ld+json">
        {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Vellore to Dharmapuri Taxi Service | Fastpik Cab",
...
<body>
    ...
    <h1 class="text-4xl font-bold text-center mb-6 text-gray-800">
        Vellore to Dharmapuri Taxi Service – Fastpikcab
    </h1>

...
<head>
    ...
    <title>Fastpik Cab - Karaikal to Erode Taxi Service | Book Online</title>

    <meta name="description"
        content="Book a reliable Karaikal to Erode taxi service with Fastpik Cab. Get affordable fares for one-way, round-trip, and outstation travel. We offer comfortable cabs for your journey.">
        ...
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
                <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900 leading-tight mb-4">
                    Reliable <span class="text-blue-600">Taxi Service</span> from Karaikal to Erode
                </h1>
            ...
            <div class="bg-white p-6 md:p-8 rounded-xl shadow-lg">
                ...
                <form action="/book-now" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="drop" name="drop" placeholder="Erode" required
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    <div>
